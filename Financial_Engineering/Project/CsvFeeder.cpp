...
//            std::cout << "Contract: " << rowData["contractName"] << " and timestamp: " << rowData["time"] << " (in epochs: " << tickData_.LastUpdateTimeStamp << ")" << std::endl;
...
//        *now_ms_ = msg_.timestamp;
        now_ms_ = msg_.timestamp + interval_.count();        
    } 
...
//            std::cout<< "NEXT INTERVAL is now_ms = " << now_ms_ << std::endl;
        }
